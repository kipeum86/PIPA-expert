...
> 릴리즈 노트는 **[GitHub Releases](https://github.com/kipeum86/PIPA-expert/releases)**에 게시합니다.
...
| 에이전트 | 역할 | 전문 분야 |
|---------|------|----------|
| **[data-protection-agent](https://github.com/kipeum86/data-protection-agent)** | **통합 개인정보 스페셜리스트** *(이 레포의 후신)* | **한국 PIPA · EU GDPR · 캘리포니아 CCPA** |
...
| [contract-review-agent](https://github.com/kipeum86/contract-review-agent) | 계약 검토 스페셜리스트 | 계약서 검토 |
