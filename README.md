...
> [!IMPORTANT]
> **Heads up — as of 2026-05-08**, the Korea PIPA (`PIPA-expert`) and EU GDPR (`GDPR-expert`) specialist agents have been folded into a unified cross-jurisdictional privacy research agent at **[`data-protection-agent`](https://github.com/kipeum86/data-protection-agent)**, together with a newly added California (CCPA-as-amended-by-CPRA) sub-KB. Routing a multi-jurisdiction privacy question to two single-jurisdiction specialists meant two token-billed runs producing two memos to reconcile by hand — and California had no specialist at all. The unified agent collapses that into a single dispatch and adds a cross-jurisdictional citation auditor that catches authority-blending across borders.
>
